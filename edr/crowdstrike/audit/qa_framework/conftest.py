...
# =============================================================================
# CRITICAL: Mock config module BEFORE any other imports
# =============================================================================
# This must be at the very top of conftest.py because pytest loads this file
# first, before any test modules. This ensures that when test_alerts_client.py
# imports alerts_client (which imports config), it gets our mock.

import sys
from unittest.mock import MagicMock

# Only mock if we haven't already (prevents issues with pytest reloading)
if 'config' not in sys.modules:
    _mock_config = MagicMock()
    _mock_config.CROWDSTRIKE.client_id = 'test_client_id'
    _mock_config.CROWDSTRIKE.client_secret = 'test_client_secret'
    _mock_config.CROWDSTRIKE.base_url = 'https://api.laggar.gcw.crowdstrike.com'
