...
def _build_finding_card(finding: dict) -> str:
    ...
    if tactic or technique:
        ...
        mitre_display = f"{tactic} → {technique_with_id}" if tactic else technique_with_id
        ...
        <div class="finding-card severity-{severity_class}">
            ...
            <div class="finding-body">
                <div class="context-section">
                    {f'<div class="context-item"><span class="label">MITRE:</span> {mitre_display}</div>' if mitre_display else ''}
