...
from ngsiem_hunter.models import ExecutionMode
from ngsiem_hunter.runner import run
...
def main(
    ...
    Examples:
        ...
        ngsiem-hunter -q queries/hunt.txt
        
        # Run iterative queries with specific CIDs
        ngsiem-hunter -q queries/hunt.txt -m iterative --cids data/target_cids.txt
        
        # Query with custom time range
        ngsiem-hunter -q queries/hunt.txt -s "-24h" -e "-1h"
    """
