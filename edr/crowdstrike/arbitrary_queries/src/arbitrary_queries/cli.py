...
from arbitrary_queries.logger import setup_logging, LogConfig, LogLevel
...
Examples:
  ...
  # Query with custom time range (LogScale format: positive relative times)
...
""",
    ...
    parser.add_argument(
        ...
        default=None,
        metavar="TIME",
        help="Query start time, e.g. '7d', '24h' (LogScale format; default: from config)",
    )
    parser.add_argument(
        "-e",
        "--end",
