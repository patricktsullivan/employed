"""
Tests for ngsiem_hunter.query_executor module.
...
from ngsiem_hunter.query_executor import (
    QueryExecutor,
    execute_query,
    poll_until_complete,
    QueryTimeoutError,
...
from ngsiem_hunter.config import QueryDefaults, ConcurrencyConfig
...
class TestQueryExecutorRunIterative:
    ...
    async def test_run_iterative_handles_partial_failures(self, executor, sample_cid_infos):
        ...
        from ngsiem_hunter.client import QuerySubmissionError
