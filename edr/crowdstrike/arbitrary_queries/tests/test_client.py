"""
Tests for ngsiem_hunter.client module.
...
from ngsiem_hunter.client import (
    CrowdStrikeClient,
    CrowdStrikeError,
    AuthenticationError,
...
from ngsiem_hunter.secrets import Credentials
from ngsiem_hunter.config import CrowdStrikeConfig
...
def client(mock_credentials, mock_cs_config):
    ...
    with patch("ngsiem_hunter.client.OAuth2") as mock_oauth:
